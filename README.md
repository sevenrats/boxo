...
[![Go Test](https://github.com/sevenrats/boxo/actions/workflows/go-test.yml/badge.svg)](https://github.com/sevenrats/boxo/actions/workflows/go-test.yml)
[![Go Docs](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/sevenrats/boxo)
...
* Run: `go run github.com/sevenrats/boxo/cmd/boxo-migrate@latest update-imports`
  * This will upgrade your module to Boxo v0.8.0 and rewrite your import paths
* Run: `go run github.com/sevenrats/boxo/cmd/boxo-migrate@latest check-dependencies`
...
If you encounter any challenges, please [open an issue](https://github.com/sevenrats/boxo/issues/new/choose) and Boxo maintainers will help you.
...
The exhaustive list is https://github.com/sevenrats/boxo/network/dependents.  Some notable projects include:
...
See https://github.com/sevenrats/boxo/issues/215. 

### Additional Docs & FAQs
See [the wiki](https://github.com/sevenrats/boxo/wiki).
