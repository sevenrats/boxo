...
import (
	...
	"github.com/sevenrats/boxo/ipld/merkledag/dagutils"
	ipfspinner "github.com/sevenrats/boxo/pinning/pinner"
	"github.com/sevenrats/boxo/pinning/pinner/dsindex"
)
...
func (p *pinner) streamIndexFromString(ctx context.Context, index dsindex.Indexer, s string) <-chan ipfspinner.StreamedCid {
	out := make(chan ipfspinner.StreamedCid)
